...
#define GPIO_PUMP_Pin GPIO_PIN_15
#define GPIO_PUMP_GPIO_Port GPIOC
#define ADC_DIRT_Pin GPIO_PIN_0
#define ADC_DIRT_GPIO_Port GPIOA
...
#define SOLAR_1_Pin GPIO_PIN_4
#define SOLAR_1_GPIO_Port GPIOA
#define SOLAR_2_Pin GPIO_PIN_5
#define SOLAR_2_GPIO_Port GPIOA
#define SOLAR_3_Pin GPIO_PIN_6
#define SOLAR_3_GPIO_Port GPIOA
#define SOLAR_4_Pin GPIO_PIN_7
#define SOLAR_4_GPIO_Port GPIOA
